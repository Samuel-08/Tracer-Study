        ...
        <div class="row">
                              ...
                              <li class="nav-item">
                                  <div class="accordion" id="contoHAccordion">
                                      ...
                                      <div class="card  ">
                                          ...
                                          <div id="Kolapspp"  class="collapse show"  aria-labelledby="Headdd" data-parent="#contoHAccordion">
                                              <div class="card-body">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-3 mb-3 ">
                    <h2>Silahkan Input Pertanyaan Anda Untuk Kategori Bekerja</h2>
                    <a href="/admin" class="btn btn-danger">Kembali</a>
                </div>
                <form action="<?= base_url('/admin/CrBekerja') ?>" method="POST">
                    <?= csrf_field(); ?>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($ss as $isi) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="/admin/editBekerja/<?= $isi['id_kuis_bekerja']; ?>" class="btn btn-outline-primary"><i class="bi bi-pen"> </i></a>
                                                        <a href="/admin/Hapus/<?= $isi['id_kuis_bekerja']; ?>" class="btn btn-outline-danger"><i class="bi bi-trash3" onclick="alert('Pertanyaan akan di hapus secara permanen');"> </i></a>
                                                    </td>
                                                </tr>
                                            <?php $no++;
                                            } ?>
