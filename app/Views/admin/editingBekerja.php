...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center">
            <form action="/admin/upBekerja/<?= $up['id_kuis_bekerja'];  ?>" method="post">
                <div class="card" style="width:40rem;">
                    <div class="card-body">
                        <?= csrf_field();  ?>
                        <div class="form-group">
                            <input type="hidden" name="id_kuis_bekerja" value="<?= $up['id_kuis_bekerja'];  ?>">
                        ...
                        <a href="/admin/LBekerja" class="btn btn-success">kembali</a>
                    </div>
                </div>
            </form>
        </div>
