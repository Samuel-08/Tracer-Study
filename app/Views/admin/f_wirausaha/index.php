   ...
   <style>
      ...
      <body>
       ...
       <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        </button>   <ul class="navbar-nav px-3">
         <li class="nav-item text-nowrap">
          <a class="nav-link mr-5" href="#">Sign out</a>
         </li>
        </ul>
       </nav>
       ...
       <div class="container-fluid">
        <div class="row">
                  ...
                  </nav> <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
          ...
          <div class="table-responsive">
           <table class="table table-striped table-sm text-center">
            ...
            <tbody>
             <?php foreach ($wirausaha as $wI => $wirausaha) : ?>
              <tr>
               <td><?= ++$wI ?></td>
               <td><?= $wirausaha['nim']; ?></td>
               <td><?= $wirausaha['nama']; ?></td>
               <td><?= $wirausaha['jurusan']; ?></td>
               <td><?= $wirausaha['tahun_lulus']; ?></td>
               <td class="bg-success text-center text-light rounded"><?= $wirausaha['status']; ?></td>
              </tr>
             <?php endforeach; ?>
            </tbody>
           </table>
