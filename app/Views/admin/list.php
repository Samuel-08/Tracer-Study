            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled font-weight-bold alert-secondary rounded" href="<?= base_url('admin/list')  ?>">
                                List Alumni
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered text-center" id="users">
                        ...
                        <?php foreach ($des as $ss) : ?>
                            <tbody>
                                <td><?= $ss['nim']; ?></td>
                                <td><?= $ss['nama']; ?></td>
                                <td><?= $ss['email']; ?></td>
                                <td><?= $ss['jurusan']; ?></td>
                                <td><?= $ss['tahun_lulus']; ?></td>
                                <td><?= $ss['status']; ?></td>

                                <td>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mod<?= $ss['id']; ?>al">
                                        Detail</button>
                                </td>
                                <!-- Button trigger modal -->
                                <!-- Modal -->
                                <div class="modal fade" id="mod<?= $ss['id']; ?>al" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="staticBackdropLabel">Data Alumni</h4>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <p><strong>Nama </strong>: <?= $ss['nama']; ?></p>
                                                <hr>
                                                <p><strong>Email </strong>: <?= $ss['email']; ?></p>
                                                <hr>
                                                <p><strong>Status </strong>: <?= $ss['status']; ?></p>
                                                <hr>
                                                <p><strong>Jenis Kelamin </strong>: <?= $ss['jenis_kelamin']; ?></p>
                                                <hr>
                                                <p><strong>Nim </strong>: <?= $ss['nim']; ?></p>
                                                <hr>
                                                <p><strong>Jurusan </strong>: <?= $ss['jurusan']; ?></p>
                                                <hr>
                                                <p><strong>Tahun Lulus </strong>: <?= $ss['tahun_lulus']; ?></p>
                                                <hr>
                                                <p><strong>Kota Kelahiran </strong>: <?= $ss['kota_kelahiran']; ?></p>
                                                <hr>
                                                <p><strong>Agama </strong>: <?= $ss['agama']; ?></p>
                                                <hr>
                                                <p><strong>Dibuat Pada </strong>: <?= $ss['created_at']; ?></p>
                                                <hr>
                                            </div>
