...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center">
            <form action="/admin/update/<?= $up['id_kuis_belajar'];  ?>" method="post">
                <div class="card" style="width:40rem;">
                    <div class="card-body">
                        <?= csrf_field();  ?>
                        <div class="form-group">
                            <input type="hidden" name="id_kuis_belajar" value="<?= $up['id_kuis_belajar'];  ?>">
                        ...
                        <a href="/admin /inputKuis" class="btn btn-success">kembali</a>
                    </div>
                </div>
            </form>
        </div>
